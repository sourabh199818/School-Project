       ...
       <a class="navbar-brand" href="index.html"><i class="fa fa-university"></i><span>College Era</span></a>
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
            ...
            <li class="active"><a href="gallery.html">Live Classes</a></li>
                  <li class="dropdown">
     ...
     <div class="row">
       <div class="col-md-12">
         <div class="mu-page-breadcrumb-area">
           <h2>Your Profile</h2>
            <li><a href="#"></a></li>            
            <li >Edit/delete your profile </li>
          </ol>
         </div>
       </div>
     </div>
...
table, th, td {
 ...
 <table>
            <?php
               ...
               $sql = "SELECT Subject, Link FROM `computernetwork` where subject = 'Java'";
     ...
     ?>  <table >
       ...
       ?> <th> <?php  echo " Java "; ?> </th><?php
       ?> <th> <?php  echo " Link Id   "; ?> </th><?php
       ?> </td> <?php
       ?> </tr> <?php
       ?> <tr> <?php
       ?> <td> <?php  echo $row['Subject']; ?> </td> <?php
   
       ?> <td> <?php   $row['Link']; ?> </td> <?php
