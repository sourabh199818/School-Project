          ...
          <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
           ...
           <li class="dropdown active">
              ...
              <ul class="dropdown-menu" role="menu">
                <li class="active"><a href="course.html">Computer Networking</a></li>                
                <li><a href="course-detail.html">Java</a></li>  
                <li><a href="course-detail.html">Python</a></li> 
                </ul>
            </li>         
            <li><a href="gallery.html">Live Classes</a></li>
                    ...
                    <div class="mu-latest-course-single">
                      <figure class="mu-latest-course-img">
                        <figcaption class="mu-latest-course-imgcaption">
                          <a href="#">Lecture-1</a>
                         <span><a href="video.php?variableName=1"><i class=""></i>Video Link</span> </a>
                        

                         <span><a href="index.php"><i class=""></i>PDF Link,</span> </a>
                        </figcaption>
                      </figure>
                  ...
                  <div class="row">
                    ...
                    <div class="mu-latest-course-single">
                      <figure class="mu-latest-course-img">
                        <figcaption class="mu-latest-course-imgcaption">
                          <a href="#">Lecture-2</a>
                         <span><a href="video.php?variableName=2"><i class=""></i>Video Link</span> </a>
                         <span><a href="index.php"><i class=""></i>PDF Link,</span> </a>
                          </figcaption>
                      </figure>
                        </div>
