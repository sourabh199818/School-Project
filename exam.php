    ...
    <nav class="navbar navbar-default" role="navigation">  
      <div class="container">
        <div class="navbar-header">
          ...
          <!-- LOGO -->              
          <!-- TEXT BASED LOGO -->
          <a class="navbar-brand" href="index.html"><i class="fa fa-university"></i><span>ERA</span></a>
          <!-- IMG BASED LOGO  -->
          ...
          <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
                <li><a href="course.php">Computer Networking</a></li>                
                <li><a href="course-detail.html">Java</a></li>  
                <li><a href="course-detail.html">Python</a></li> 
                </ul>
            </li>         
            <li class= "active"><a href="exam.html">Exam</a></li>
                  <li class="dropdown">
         ...
         <div class="mu-gallery-area">
          ...
          <div class="mu-gallery-content">
            ...
            <div class="mu-gallery-top">              
              <ul>
                <li class="filter" data-filter=".lab">Java </li>
                <li class="filter" data-filter=".classroom">Computer Network</li>
                <li class="filter" data-filter=".library">Maths</li>
                <li class="filter" data-filter=".cafe">Python</li>
                    ...
                    <div class="mu-single-gallery-item">
                      ...
                      <div class="mu-single-gallery-info">
                        <div class="mu-single-gallery-info-inner">
                          ...
                          <a href="examphp.php?variableName=Java" class="aa-link"><span class="fa fa-link"></span></a>
                        </div>
                      </div>                  
                    </div>
                  </div>
